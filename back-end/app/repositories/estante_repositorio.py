...
class EstanteRepositorio:
    def adicionar_ou_atualizar(self, id_usuario: int, id_livro: int, status: str) -> Estante | None:
        """
    ...
    def listar_por_usuario(self, id_usuario: int) -> list[Estante]:
        """
    ...
    def remover(self, id_usuario: int, id_livro: int) -> bool:
        """
    ...
    def buscar_por_usuario_e_livro(self, id_usuario: int, id_livro: int) -> Estante | None:
        """
